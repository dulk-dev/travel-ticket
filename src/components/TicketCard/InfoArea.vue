<template>
  ...
  >
    <div class="flex flex-col gap-[0.3em]">
      ...
      <!-- 日期：字号为基准的 1.15 倍 -->
      <div
        class="font-medium tracking-[0.06em] opacity-85"
      ...
      <div
        class="font-mono tracking-[0.1em] opacity-90"
      ...
      <div
        class="font-mono tracking-[0.1em] opacity-70"
        style="font-size: 0.95em"
      >
...
const locationLines = computed(() => {
  ...
  if (/[\u4e00-\u9fff]/.test(location)) {
    ...
    const pinyinUnits = pinyin(cleanLocation, {
      toneType: "none",
      type: "array",
    });
